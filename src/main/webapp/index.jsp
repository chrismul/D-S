	...
	<section class="container login-form">
		<section>
			<form name="loginform" method="post" action="" role="login">
				<h2 class="form-signin-heading">iLib Login</h2>
				...
				<button type="button" value='signup' name="signup" class="btn btn-primary btn-block" onclick="location.href='addUser.jsp';">Sign Up</button>
				<%
